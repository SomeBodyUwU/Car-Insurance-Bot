...
namespace CarInsuranceBot.Models
{
    public static class Prompts
    {
        ...
        public static class UserPrompt
        {
            ...
            public const string priceConfirmationDeny = "Used disagreed with the fixed 100 USD insurance price. Apologize and explain that 100 USD is the only available price.";
